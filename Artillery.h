...
public:
    ...
    void new_click(float& x, float& y, const sf::FloatRect& bounds, sf::RenderTarget& window, const sf::Vector2i& mouse);
    ...
    int update(float& deltaTime, sf::Clock& clock, sf::Time& elapsed, sf::Time& attack1, 
