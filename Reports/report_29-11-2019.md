...
Arthur did a smooth black transition while going from a map to another. He aslo updated the player movement function in order to have a smooth and bloc to bloc movements. Next week he will work on the finding of pokemons in the grass and iteraction with the PNGs.
