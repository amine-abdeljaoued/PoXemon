/*
 * File:   Blur2.frag
 * Authors: Laurent Gomila (original version)
 *
 * Shader for a blur effect

Notice from the original version:
Sourced from: https://github.com/SFML/SFML-Game-Development-Book/blob/master/08_Graphics/Media/Shaders/GuassianBlur.frag 
 */
